    ...
    <div className="bg-secondary px-4 py-6 rounded-2xl shadow-2xl max-w-5xl w-full mx-2 animate-fadeIn">
      ...
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          <img src={assets.menuEdit} alt="tambah-menu" className="w-6 h-6" />
          <h2 className="text-lg font-bold text-solidThree">Ubah Menu</h2>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 flex flex-col">
        ...
        <div className="flex justify-center">
          ...
          >
            <img src={assets.editMenu} width={20} />
            {loading ? "Mengubah..." : "Ubah Menu"}
          </button>
        </div>
      </form>
    </div>
